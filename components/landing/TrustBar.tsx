...
export function TrustBar() {
  return (
    <div className="border-b border-t border-[#E5E7EB] bg-white py-[18px] px-6 dark:border-white/8 dark:bg-[#0F2318]">
      <div className="mx-auto flex max-w-[1100px] flex-wrap items-center justify-center gap-8">
        {SIGNALS.map((signal, i) => (
          <div
            key={signal}
            className="reveal-visible flex items-center gap-2 text-[13px] font-medium text-[#6B7280] dark:text-[#9CA3AF]"
            style={{ animationDelay: `${i * 80}ms` }}
          >
            <svg width="16" height="16" fill="none" className="shrink-0 text-[#10B981]">
